...
asreview simulate data/Jerayaman_2020_cleaned.csv -s simulation_output/lstm_doc2vec.asreview --model lstm --feature_extraction doc2vec --n_queries min --seed 200 --n_prior_included 10 --n_prior_excluded 10 --init_seed 200
asreview simulate data/Jerayaman_2020_cleaned.csv -s simulation_output/gru_doc2vec.asreview --model gru --feature_extraction doc2vec --n_queries min --seed 200 --n_prior_included 10 --n_prior_excluded 10 --init_seed 200
